...
<div id="mySidenav" class="sidenav">
  ...
  <a href="editeducation.php">Educational details</a>
  <a href="deleteedurec.php">delete record</a>
  <a href="deletemarks.php">delete marklist</a>
...
<button class="but" onclick="window.location.href='mainpgstaff.php';">GO BACK</button>
	<button class="but" onclick="window.location.href='editeducation.php';">CLEAR</button>
