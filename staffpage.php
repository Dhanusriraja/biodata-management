...
</script><img src="img/st.gif" class="maranjupoo" align="right" height="500px" width="600px">
</body>
...
<button onclick="window.location.href='staffpage.php';" style="vertical-align: bottom;" class="btn">refresh</button>
...
echo '<td><input type="hidden" name="message" value="'.$row['message'].'" class="form-control">
...
<button onclick="window.location.href='staffpage.php';" style="vertical-align: bottom;" class="btn">refresh</button>
<center><h1 style="font-size: 20px; font-family: cursive; vertical-align: top;" >send your message</h1></center>
