...
<center><h5> SEM 5 MARKLIST</h5></center>
...
<tr>
	...
	<tr>
		...
		<td><input class="form-control" type="text" name="mon_pass7" placeholder="month of pass" ></td>
					...
					<input class="btn-sub" type="submit" name="submit" value="submit"><button class="btn" onclick="window.location.href='sem6.php';">next&nbsp<i class="fa fa-arrow-right" aria-hidden="true"></i></button>
</center>
...
{
    $count=0;
    $sql="SELECT register_no FROM sem5";
...
$pass7=$_POST['mon_pass7'];
 ...
 mysqli_query($ds,"INSERT INTO `sem5` VALUES ('$reg','$bat','$sub','$int','$ext','$tot','$pass'),('$reg','$bat','$sub1','$int1','$ext1','$tot1','$pass1'),('$reg','$bat','$sub2','$int2','$ext2','$tot2','$pass2'),('$reg','$bat','$sub3','$int3','$ext3','$tot3','$pass3'),('$reg','$bat','$sub4','$int4','$ext4','$tot4','$pass4'),('$reg','$bat','$sub5','$int5','$ext5','$tot5','$pass5'),('$reg','$bat','$sub6','$int6','$ext6','$tot6','$pass6'),('$reg','$bat','$sub7','$int7','$ext7','$tot7','$pass7');");
