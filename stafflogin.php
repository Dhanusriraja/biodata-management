...
<div class="main"><div class="child">
<h1>Login</h1>
<input type="text" name="username" id="register_no" placeholder="username">
<input type="password" name="password" id="password" placeholder="password"><br>		
<input type="submit" class="btn" name="submit" value="login"><br>
<div class="register">dont have an account? 
<a href="staffregistration.php" class="register-list">register</a>
</div>
</div>
</div>	
</form>
...
{
$count=0;
$res=mysqli_query($ds,"SELECT * FROM `staffaccounts` WHERE username='$_POST[username]' && password='$_POST[password]';");
