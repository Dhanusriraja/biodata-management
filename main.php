	...
	<header>
		...
		<?php
	  		  ...
	  		  {?>
	  		  	...
	  		  	<nav class="nav">
	  		  		<a href="myprofile.php" class="i"><b>MY PROFILE</b></a>
...
<div id="mySidenav" class="sidenav">
	<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
 	<center>
<img  src="./img/<?php echo $_SESSION['pic']; ?>" class="pro" height="150" width="150" style="border: 4px solid black;">
...
</script><img src="img/d7.gif" class="img" align="right" height="500px" width="600px">


</body>
<!--________________________message box____________________-->

	<!--<button onclick="window.location.href='main.php';">refresh</button>-->
<div id="msg" class="msg" style="display: none;">
<button onclick="window.location.href='main.php';" style="vertical-align: bottom;" class="btn">refresh</button>
...
<!--_______________send message____________________________-->
<div id="permsg" class="permsg" style="display: none;">
	<button onclick="window.location.href='main.php';" style="vertical-align: bottom;" class="btn">refresh</button>
<center><h1 style="font-size: 20px; font-family: cursive; vertical-align: top;color: white ; align-items: center;" >send your message</h1></center>
<form name="sendmsg" method="POST">
<div class="wrap">	<label>from:</label>
	<input type="text" name="msgfrom" value="<?php echo $_SESSION['login_user']; ?>" class="form-control"></div><div class="wrap">
<label>to:</label>
